...
+ To obtain a publicly available fingernail image dataset from Roboflow, consisting of at least 3,000 labeled images across a minimum of 5 distinct nail feature classes, with each image meeting a minimum resolution of 224×224 pixels. The dataset should undergo standardized preprocessing steps including resizing and normalization to ensure consistency and suitability for deep learning. In parallel, a curated statistical dataset will be developed to be used for Bayesian inference, containing percentage-based associations between these nail feature classes and systemic diseases derived from published clinical and epidemiological studies and literature.
